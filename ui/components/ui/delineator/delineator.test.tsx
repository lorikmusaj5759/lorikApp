...
describe('Delineator Component', () => {
  ...
  const headerComponent = <Text color={TextColor.textAlternative}>{HEADER_TEXT_MOCK}</Text>;
  ...
  it('forces header text color properly when type is error', () => {
    ...
    expect(getByText(HEADER_TEXT_MOCK)).toHaveClass('mm-box--color-error-default');
  });
